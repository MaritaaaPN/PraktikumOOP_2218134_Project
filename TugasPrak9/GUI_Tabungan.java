...
public class GUI_Tabungan extends javax.swing.JFrame {
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHitungActionPerformed
        ...
        else if(cmbMenu.getSelectedIndex() == 2)
        {
            ...
            JOptionPane.showMessageDialog(null, "Biaya Admin Sebesar Rp 5000","Warning", 2);
        }
        catch(NumberFormatException d){
            JOptionPane.showMessageDialog(null, "Input Tidak Sesuai","Warning", 2);
        }
        finally{
            JOptionPane.showMessageDialog(null, "Terimakasih Sudah Melakukan Transaksi Bersama Kami");
        }
