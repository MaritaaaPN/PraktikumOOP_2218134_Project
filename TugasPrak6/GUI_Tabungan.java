...
public class GUI_Tabungan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (table_Tabungan.getColumnModel().getColumnCount() > 0) {
            table_Tabungan.getColumnModel().getColumn(5).setHeaderValue("Alamat");
        }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        info.alamat = (txtAlamat.getText());
        // Mengatur data private Informasi Saldo menggunakan nilai dari komponen txtInfo
        info.setinfoSaldo(Integer.parseInt(txtInfo.getText()));
        ...
        list.add(info.alamat);
        list.add(info.getinfoSaldo());
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHitungActionPerformed
        ...
        {
            txtInfo.setText(Integer.toString(info.infoSaldo()));
        }
        else if(cmbMenu.getSelectedIndex() == 1)
        {
            ...
            txtInfo.setText(Integer.toString(setor.infoSaldo()));
        }
        else if(cmbMenu.getSelectedIndex() == 2)
        {
            ...
            txtInfo.setText(Integer.toString(tarik.infoSaldo()));
        }
