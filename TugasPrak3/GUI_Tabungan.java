...
public class GUI_Tabungan extends javax.swing.JFrame {
    ...
    public GUI_Tabungan() {
        initComponents();
        Tabungan tabungan = new Tabungan(5000000);
        txtsawal.setText(Integer.toString(tabungan.saldoAwal));
        txtsawal.setEnabled(false);
    }
    ...
    private void btncetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakActionPerformed
        ...
        tabungan.dataNo(Integer.parseInt(txtno.getText()));
        ...
        memotabungan.append("No. Tabungan       : " + tabungan.noTabungan + "\n");
        ...
        memotabungan.append("Saldo Awal         : Rp " + tabungan.saldoAwal + "\n");
