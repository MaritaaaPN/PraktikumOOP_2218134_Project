...
public class Gui_Penilaian extends javax.swing.JFrame {
    ...
    public void koneksi() throws SQLException {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost/OOP_2218134?user=root&password=");
    ...
    public void tampil() {
        ...
        try {
            ...
            table_penilaian.setModel(tabelhead);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        table_penilaian.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_penilaianMouseClicked(evt);
            }
        });
    ...
    private void table_penilaianMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_penilaianMouseClicked
        // TODO add your handling code here:
        //masukkan source code onclick pada tabel
        int table = table_penilaian.getSelectedRow(); //0
        nim1 = table_penilaian.getValueAt(table, 0).toString();
        kd_mk1 = table_penilaian.getValueAt(table, 1).toString();
        np1 = table_penilaian.getValueAt(table, 2).toString();
        np2 = table_penilaian.getValueAt(table, 3).toString();
        UTS = table_penilaian.getValueAt(table, 4).toString();
        np3 = table_penilaian.getValueAt(table, 5).toString();
        PRAK = table_penilaian.getValueAt(table, 6).toString();
        UAS = table_penilaian.getValueAt(table, 7).toString();
        NA = table_penilaian.getValueAt(table, 8).toString();
        itempilih();

    }//GEN-LAST:event_table_penilaianMouseClicked
