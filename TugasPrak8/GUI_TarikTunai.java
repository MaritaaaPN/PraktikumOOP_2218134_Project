...
public class GUI_TarikTunai extends javax.swing.JFrame {
    ...
    public GUI_TarikTunai() {
        ...
        DefaultTableModel dataModel = (DefaultTableModel)tableTarik.getModel();
    ...
    private void initComponents() {
        ...
        tableTarik = new javax.swing.JTable();
        ...
        tableTarik.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Tanggal", "Tarik", "Total Saldo"
            }
        ));
        jScrollPane2.setViewportView(tableTarik);
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHitungActionPerformed
        ...
        txtTotal.setText(Integer.toString(tarik.BiayaAdmin()));
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        tableTarik.setAutoCreateColumnsFromModel(true);
        
        // Membuat instance dari kelas Mahasiswa
        Tabungan_TarikTunai tarik = new Tabungan_TarikTunai();
        // Mengatur data Tanggal menggunakan nilai dari komponen txtTanggal
        tarik.tanggal = (txtTanggal.getText());
        // Mengatur data private Nominal Tarik menggunakan nilai dari komponen txtTarik
        tarik.setnoTarik(Integer.parseInt(txtTarik.getText()));
        // Mengatur data private Informasi Saldo menggunakan nilai dari komponen txtTotal
        tarik.setBiayaAdmin(Integer.parseInt(txtTotal.getText()));
        // Menambahkan data-data dari objek setor ke dalam ArrayList 'list'
        list.add(tarik.tanggal);
        list.add(tarik.getnoTarik());
        list.add(tarik.getBiayaAdmin());
    ...
    private javax.swing.JTable tableTarik;
